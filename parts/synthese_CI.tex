...
Nous nous retrouvons avec une configuration versatile : elle peut être exportée facilement et profite de toute l'expressivité de l'API Python pour ZAP. L'OWASP propose des images Docker de ZAP
% TODO : lien vers le git zap2docker
...
% TODO : mettre un lien vers l'image spéciale CI
...
% TODO : chercher le nom de l'image, python3:alpine ?
...
% TODO : snippet pour générer l'artefact
%TODO : screenshot page de récap du job sur gitlab 
