...
Mettre une note\footnote{http://www.alter-solutions.com/notre-societe/chiffres-cles/}.
375 collaborateurs en France, Portugal et Belgique (combien dans chaque pays ?)

\subsection{Répartition de l'activité}
\begin{tikzpicture}
    \pie[color ={ black!10 , black!20, black!30,  black!40}, explode=0.1]{10/A, 20/B, 30/C, 40/D}
\end{tikzpicture}