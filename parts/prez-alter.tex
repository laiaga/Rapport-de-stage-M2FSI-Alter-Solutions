	...
	\frame{
		\begin{tikzpicture}
			\begin{axis}
				...
				%TODO : gérer couleurs peut-être comme ici
				% https://tex.stackexchange.com/questions/320797/horizontal-bar-chart-with-different-colors-for-each-bar
				\addplot
				[
					draw=ppurple, 
					pattern=horizontal lines light ppurple
				]
				coordinates
				{
					(33,Énergies)
